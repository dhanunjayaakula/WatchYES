...
WebUI.click(findTestObject('Object Repository/Launch/Page_Watch  YES Network/div_Already subscribe to YES NetworkLOGIN W_e9acde'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Launch/Page_Watch  YES Network/div_Already subscribe to YES NetworkLOGIN W_e9acde'), 
    0)
